 ...
 *   appcmd(flash, "write -a 1000 -n 16")        → 从 buf 写 n B  ⚠️ 破坏性
 *   appcmd(flash, "erase -a 0 -s 4096")         → 4K 扇区擦除   ⚠️ 破坏性
 *   appcmd(flash, "ce")                         → 全片擦除       ⚠️ 破坏性
 *
 * ⚠️ 破坏性命令警告: write/erase/ce 会改写/擦除 W25Q64 原始数据, 直接摧毁
