/**
 * @file    button16.c
 * @note    4×4 矩阵键盘扫描应用 (Linux BSP, SDL2 键盘状态)
 *
 * ============================================================
 * 基本信息
 * ============================================================
...
/* SDL 键盘状态由同属 Linux 预设的 gui_drv.c 维护 (SDL 事件泵在 sys_idle 中驱动) */
extern int kscgui_sdl_key_down(int idx);
...
/* ========================================================================
 *  Linux 平台 — 键扫描 (SDL2 键盘状态, 模拟 STM32 官方布局)
 * ======================================================================== */
 ...
 *
 * 键位索引 → SDL scancode 的映射表定义在 gui_drv.c (s_key_scancodes[]),
 * 本文件只通过 kscgui_sdl_key_down(i) 查询, 不直接依赖 SDL。
 */
...
REGISTER_APP_EX("button16", "0", "0",
                &btn16_ops, "4x4 matrix keypad scanner (Linux: SDL2 keys)");
